...
//                    atesty[tableIndex].setNazwa(resultSet.getString("nazwa"));
//                    atesty[tableIndex].setId(resultSet.getInt("id"));
//                    atesty[tableIndex].setIdMaterialu(resultSet.getInt("id_materialu"));
//                    atesty[tableIndex].setPositionInTable(tableIndex);
     ...
     * @param nazwaMaterialu Nazwa materiału którego atesty mają zostać
     * odszukane.
     */
...
//                                atestyTmp[tableIndex] = new Atest();
//                                atestyTmp[tableIndex].setNazwa(resultSet1.getString("nazwa"));
//                                atestyTmp[tableIndex].setId(resultSet1.getInt("id"));
//                                atestyTmp[tableIndex].setIdMaterialu(resultSet1.getInt("id_materialu"));
//                                atestyTmp[tableIndex].setPositionInTable(tableIndex);
                                tableIndex += 1;

                            } while (resultSet1.next());

                            /* Tablica sumująca wyniki z tablicy tymaczsowej oraz
                                tablicy głównej. */
                            //Atest[] atestyTmp2 = new Atest[atesty.length + atestyTmp.length];
                            //Atest[] atestyTmp2 = new Atest[atesty.size() + atestyTmp.length];
                            /* Skopiowanie danych tablicy głównej i tymczsowej do
                                tablicy sumującej dane i nadpisanie tablicy 
                                głównej. */
                            //System.arraycopy(atesty, 0, atestyTmp2, 0, atesty.size());
                            //System.arraycopy(atestyTmp, 0, atestyTmp2, atesty.size(), atestyTmp.length);
                            //atesty = atestyTmp2;
                            for (Atest atest : atestyTmp) {
                                //System.out.println("Nazwa" + atest.getNazwa());
                                atesty.add(atest);
                            }
                        }
...
//            DatabaseManager.getInstance().addCertIntoBom(atesty[tblOutput.getSelectedRow()].getId(),
...
//                    System.out.println("Id boma"
//                            + BomManager.getInstance().getCertToManyBoms().get(i).getId()
//                    );
